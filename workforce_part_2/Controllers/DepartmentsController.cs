...
namespace workforce_part_2.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(workforce_part_2Context context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DepartmentName,EmployeeName")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DepartmentName,EmployeeName")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
